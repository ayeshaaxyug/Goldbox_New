...
public class Scheme_SchemesList_ManageTenureAmountPage {  
    ...
    @FindBy(xpath="//th[.='Tenure in Amount']/../../following-sibling::tbody//td[.='1000']/..//i[@class='fas fa-trash-alt']")private WebElement ActionDeleteBtn ;
	...
	{
		Thread.sleep(3000);
		driver.findElement(By.xpath("//th[.='Tenure in Amount']/../../following-sibling::tbody//td[.='"+Amount+"']/..//i[@class='fas fa-trash-alt']")).click();
		Thread.sleep(3000);
		EnterAmountEdt.sendKeys(Amount);
		Thread.sleep(3000);
		AddBtn.click();
