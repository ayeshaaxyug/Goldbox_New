...
public class Schemes_SchemeListPage {
    ...
    @FindBy(xpath="((//td[.='Festive Plan']/..//td/button[.=' View ']/../following-sibling::td/button[.=' Info '])[1]/../following-sibling::td)[1]/following-sibling::td/button[.=' Edit ']/..//div[@class='mdc-switch__ripple']")private WebElement SchemeEnableDisableBootstrapBtn;
