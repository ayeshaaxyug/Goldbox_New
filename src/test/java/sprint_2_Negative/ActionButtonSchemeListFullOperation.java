...
public class ActionButtonSchemeListFullOperation {
	...
	public void actionButtonSchemeListFullOperationTest()throws Exception
	{
        ...
        Thread.sleep(3000);
		driver.findElement(By.xpath("//h4[.='Scheme Info']/../../following-sibling::div//textarea[@formcontrolname='content']/../../../../following-sibling::div//textarea[@formcontrolname='tc']")).sendKeys("follow");
		Thread.sleep(3000);
