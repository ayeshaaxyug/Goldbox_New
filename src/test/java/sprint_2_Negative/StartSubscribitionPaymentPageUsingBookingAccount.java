...
public class StartSubscribitionPaymentPageUsingBookingAccount {
	...
	public void startSubscribitionPaymentPageTest()throws Exception
	{
		...
		driver.findElement(By.xpath("//input[@placeholder='Enter amount']")).sendKeys("1000",Keys.ENTER);
		...
		WebElement ErrorMessage = driver.findElement(By.xpath("//button[.='Pay Now']"));
		
		Thread.sleep(2000);
	
		if (ErrorMessage.isDisplayed())
		{
			w.takeScreenShot(driver,"startSubscribitionPaymentPage" );
			Thread.sleep(2000);
		} 
      	else 
		{
